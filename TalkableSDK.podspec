...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/talkable/talkable-ios-sdk"
  ...
  spec.source       = { :git => "https://github.com/talkable/talkable-ios-sdk.git", :tag => "#{spec.version}" }
  spec.source_files  = "Talkable/**/*.{h,m,swift}", "3rdParty/**/*.{h,m}"

  spec.ios.frameworks = "UIKit", "Contacts", "WebKit", "Social", "MessageUI", "Foundation"
